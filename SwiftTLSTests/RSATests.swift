...
class RSATests: XCTestCase {
    ...
    {
        let certificatePath = Bundle(for: self.dynamicType).pathForResource("Self Signed RSA SHA-256.cer", ofType: "")!
...
//        let certificatePath = Bundle(for: self.dynamicType).urlForResource("mycert2.pem", withExtension: nil)!.path!
//        
//        guard let rsa = RSA.fromPEMFile(certificatePath) else {
//            XCTFail()
//            return
