...
// This is a translation of rijndael-alg-fst.c

private let Te0: [UInt32] = [
 ...
 */
private func rijndaelKeySetupEnc(_ rk: inout [UInt32], _ cipherKey: [UInt8], _ bitSize: AES.BitSize) {
    var temp: UInt32
    
    rk[0] = UInt32(bigEndianBytes: cipherKey[0..<4])!
    rk[1] = UInt32(bigEndianBytes: cipherKey[4..<8])!
    rk[2] = UInt32(bigEndianBytes: cipherKey[8..<12])!
    rk[3] = UInt32(bigEndianBytes: cipherKey[12..<16])!
    ...
    case .aes128:
        ...
        for i in 0..<10 {
            ...
            rk[offset + 4] = rk[offset + 0] ^
                (Te4[Int((temp >> 16) & 0xff)] & 0xff000000) ^
                (Te4[Int((temp >>  8) & 0xff)] & 0x00ff0000) ^
                (Te4[Int((temp      ) & 0xff)] & 0x0000ff00) ^
                (Te4[Int( temp >> 24)        ] & 0x000000ff) ^
                rcon[i]
...
private func rijndaelKeySetupDec(_ rk: inout [UInt32], _ cipherKey: [UInt8], _ bitSize: AES.BitSize) {
    ...
    rijndaelKeySetupEnc(&rk, cipherKey, bitSize)
    
    /* invert the order of the round keys: */
    var i = 0
    var j = 4 * bitSize.rounds
    while i < j {
    ...
    var offset = 0
    for _ in 1..<bitSize.rounds {
        offset += 4
        rk[offset + 0] =
            Td0[Int(Te4[Int((rk[offset + 0] >> 24)       )] & 0xff)] ^
            Td1[Int(Te4[Int((rk[offset + 0] >> 16) & 0xff)] & 0xff)] ^
            Td2[Int(Te4[Int((rk[offset + 0] >>  8) & 0xff)] & 0xff)] ^
            Td3[Int(Te4[Int((rk[offset + 0]      ) & 0xff)] & 0xff)]
        rk[offset + 1] =
            Td0[Int(Te4[Int((rk[offset + 1] >> 24)       )] & 0xff)] ^
            Td1[Int(Te4[Int((rk[offset + 1] >> 16) & 0xff)] & 0xff)] ^
            Td2[Int(Te4[Int((rk[offset + 1] >>  8) & 0xff)] & 0xff)] ^
            Td3[Int(Te4[Int((rk[offset + 1]      ) & 0xff)] & 0xff)]
        rk[offset + 2] =
            Td0[Int(Te4[Int((rk[offset + 2] >> 24)       )] & 0xff)] ^
            Td1[Int(Te4[Int((rk[offset + 2] >> 16) & 0xff)] & 0xff)] ^
            Td2[Int(Te4[Int((rk[offset + 2] >>  8) & 0xff)] & 0xff)] ^
            Td3[Int(Te4[Int((rk[offset + 2]      ) & 0xff)] & 0xff)]
        rk[offset + 3] =
            Td0[Int(Te4[Int((rk[offset + 3] >> 24)       )] & 0xff)] ^
            Td1[Int(Te4[Int((rk[offset + 3] >> 16) & 0xff)] & 0xff)] ^
            Td2[Int(Te4[Int((rk[offset + 3] >>  8) & 0xff)] & 0xff)] ^
            Td3[Int(Te4[Int((rk[offset + 3]      ) & 0xff)] & 0xff)]
    }
}

private func rijndaelEncrypt(_ rk: [UInt32], Nr: Int, pt: [UInt8], ct: inout [UInt8]) {
    /*
     * map byte array block to cipher state
     * and add initial round key:
     */
    var s0 = UInt32(bigEndianBytes: pt[ 0..<4])! ^ rk[0]
    var s1 = UInt32(bigEndianBytes: pt[ 4..<8])! ^ rk[1]
    var s2 = UInt32(bigEndianBytes: pt[ 8..<12])! ^ rk[2]
    var s3 = UInt32(bigEndianBytes: pt[12..<16])! ^ rk[3]
    
    /*
     * Nr - 1 full rounds:
     */
    
    var t0: UInt32 = 0 // these don't need to be initialized, but the compiler is confused
    var t1: UInt32 = 0
    var t2: UInt32 = 0
    var t3: UInt32 = 0
    var r = Nr >> 1
     ...
     */
    s0 =
        (Te4[Int((t0 >> 24)       )] & 0xff000000) ^
        (Te4[Int((t1 >> 16) & 0xff)] & 0x00ff0000) ^
        (Te4[Int((t2 >>  8) & 0xff)] & 0x0000ff00) ^
        (Te4[Int((t3      ) & 0xff)] & 0x000000ff) ^
        rk[offset + 0]
    ct.replaceSubrange(0..<4, with: s0.bigEndianBytes)

    s1 =
        (Te4[Int((t1 >> 24)       )] & 0xff000000) ^
        (Te4[Int((t2 >> 16) & 0xff)] & 0x00ff0000) ^
        (Te4[Int((t3 >>  8) & 0xff)] & 0x0000ff00) ^
        (Te4[Int((t0      ) & 0xff)] & 0x000000ff) ^
        rk[offset + 1]
    ct.replaceSubrange(4..<8, with: s1.bigEndianBytes)

    s2 =
        (Te4[Int((t2 >> 24)       )] & 0xff000000) ^
        (Te4[Int((t3 >> 16) & 0xff)] & 0x00ff0000) ^
        (Te4[Int((t0 >>  8) & 0xff)] & 0x0000ff00) ^
        (Te4[Int((t1      ) & 0xff)] & 0x000000ff) ^
        rk[offset + 2]
    ct.replaceSubrange(8..<12, with: s2.bigEndianBytes)

    s3 =
        (Te4[Int((t3 >> 24)       )] & 0xff000000) ^
        (Te4[Int((t0 >> 16) & 0xff)] & 0x00ff0000) ^
        (Te4[Int((t1 >>  8) & 0xff)] & 0x0000ff00) ^
        (Te4[Int((t2      ) & 0xff)] & 0x000000ff) ^
        rk[offset + 3]
    ct.replaceSubrange(12..<16, with: s3.bigEndianBytes)
}

private func rijndaelDecrypt(_ rk: [UInt32], Nr: Int, ct: [UInt8], pt: inout [UInt8]) {
    
    /*
     * map byte array block to cipher state
     * and add initial round key:
     */
    var s0 = UInt32(bigEndianBytes: ct[ 0..<4])! ^ rk[0]
    var s1 = UInt32(bigEndianBytes: ct[ 4..<8])! ^ rk[1]
    var s2 = UInt32(bigEndianBytes: ct[ 8..<12])! ^ rk[2]
    var s3 = UInt32(bigEndianBytes: ct[12..<16])! ^ rk[3]
     ...
     */
    s0 =
        (Td4[Int((t0 >> 24)       )] & 0xff000000) ^
        (Td4[Int((t3 >> 16) & 0xff)] & 0x00ff0000) ^
        (Td4[Int((t2 >>  8) & 0xff)] & 0x0000ff00) ^
        (Td4[Int((t1      ) & 0xff)] & 0x000000ff) ^
        rk[offset + 0]
    pt.replaceSubrange(0..<4, with: s0.bigEndianBytes)

    s1 =
        (Td4[Int((t1 >> 24)       )] & 0xff000000) ^
        (Td4[Int((t0 >> 16) & 0xff)] & 0x00ff0000) ^
        (Td4[Int((t3 >>  8) & 0xff)] & 0x0000ff00) ^
        (Td4[Int((t2      ) & 0xff)] & 0x000000ff) ^
        rk[offset + 1]
    pt.replaceSubrange(4..<8, with: s1.bigEndianBytes)

    s2 =
        (Td4[Int((t2 >> 24)       )] & 0xff000000) ^
        (Td4[Int((t1 >> 16) & 0xff)] & 0x00ff0000) ^
        (Td4[Int((t0 >>  8) & 0xff)] & 0x0000ff00) ^
        (Td4[Int((t3      ) & 0xff)] & 0x000000ff) ^
        rk[offset + 2]
    pt.replaceSubrange(8..<12, with: s2.bigEndianBytes)

    s3 =
        (Td4[Int((t3 >> 24)       )] & 0xff000000) ^
        (Td4[Int((t2 >> 16) & 0xff)] & 0x00ff0000) ^
        (Td4[Int((t1 >>  8) & 0xff)] & 0x0000ff00) ^
        (Td4[Int((t0      ) & 0xff)] & 0x000000ff) ^
        rk[offset + 3]
    pt.replaceSubrange(12..<16, with: s3.bigEndianBytes)
}
...
struct AES {
    ...
    {
        var roundKey = [UInt32](repeating: 0, count: 4 * (bitSize.rounds + 1))
        if encrypt {
            rijndaelKeySetupEnc(&roundKey, key, bitSize)
    ...
    func update(indata: [UInt8], outdata: inout [UInt8]) {
        switch direction {
        case .encrypting:
            rijndaelEncrypt(roundKey, Nr: bitSize.rounds, pt: indata, ct: &outdata)

        case .decrypting:
            rijndaelDecrypt(roundKey, Nr: bitSize.rounds, ct: indata, pt: &outdata)
        }
    }
}
